streamlit is an open source python framework that allows data scientists, AI developers to build interactive and beautiful websites using just few lines of code. It ends the need of learning front-end web development tools like html, css and javascript.
Key Features

1. Pure Python: You can create complete web UIs (including sliders, buttons, text inputs, and charts) entirely in Python.
